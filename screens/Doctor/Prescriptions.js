...
function Prescriptions({navigation}) {
    ...
    async function loadPrescriptions(){ 
        ...
        const query = presciptionRef.where('did', '==', await AsyncStorage.getItem('uid'));
            ...
            <Modal
                ...
                <View style={styles.modalContainer}>
                    ...
                    <View style={{flexDirection:'row', paddingHorizontal:10, marginBottom:30, borderBottomWidth:1,borderTopWidth:1, borderColor:'white', justifyContent:'space-around'}}>
                            <Pressable android_ripple={{color:'#e3e3e3'}} style={{justifyContent: 'center',padding:20}} onPress={() => {setIsVisible(false);navigation.navigate('EditPrescription',{pres:selectedPres})}} >
